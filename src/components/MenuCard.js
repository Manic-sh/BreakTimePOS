...
class ProductCardItem extends React.Component {
  ...
  render() {
    ...
    return (
      <Card style={{ padding: 8, border: "none" }} onClick={this.addProduct}>
        <Meta
          avatar={
            <Avatar src="https://i1.wp.com/www.raynauds.org/wp-content/uploads/2019/07/Cold-Drink.jpg?resize=272%2C300&ssl=1" />
          }
